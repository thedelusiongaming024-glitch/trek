...
export async function createApp() {
  ...
  const defaultSettings: Record<string, any> = {
    forumName: 'Trek Consultancy & Community',
    forumTagline: 'Professional Business Setup & Strategic Advisory in Saudi Arabia',
    ...
    floatingSupportTagTextEn: 'Ask Trek AI',
    floatingSupportTagTextBn: 'ট্রেক এআই-কে জিজ্ঞাসা করুন'
  };
